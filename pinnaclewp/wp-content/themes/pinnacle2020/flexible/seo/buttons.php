...
<div class="button-container mt2">
  <?php if(get_sub_field('include_games_button')):?>
    ...
    <?php if(get_sub_field('include_custom_button')):?>
      <div class="button-align">
        <a href="<?php print get_sub_field('custom_button_url_full');?>" title="<?php print get_sub_field('custom_button_text');?>" class="button"><?php print get_sub_field('custom_button_text');?></a>
      </div>
    <?php endif; ?>
</div>
<?php endif; ?>
